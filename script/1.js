...
<div id="items-bar">
    ...
    <a class="item-link" href="#">Proyectos</a>
...
<div>
    <img class="img-banner" src="img/b.jpg" alt="">
</div>
<div>
    <img class="img-banner" src="img/c.jpg" alt="">
</div>
<div>
    <img class="img-banner" src="img/d.jpg" alt="">
</div>
<div>
    <img class="img-banner" src="img/e.jpg" alt="">
</div>
</div>
...
<div id="text-content-banner">
    <h1 id="title-banner">HERMETICIDAD Y ESTILO DE ALTA CALIDAD</h1>
    <p id="text-banner">Ofrecemos servicios de calidad con el mejor personal para tu empresa , oficina y hogar.</p>
...
<div id="sect-prod" class="container ">
    <div class="sec-1-prod">
        ...
        <img class="img-sec1" src="img/1.png" alt="">
        </div>
        <h3 class="tit-sec1">Ventanas</h3>
    </div>
    <div class="sec-1-prod">
        <div class="sec1-prod-cont">
        <img class="img-sec1" src="img/2.png" alt="">
        </div>
        <h3 class="tit-sec1">Policarbonato</h3>
    </div>
    <div class="sec-1-prod">
        <div class="sec1-prod-cont">
        <img class="img-sec1" src="img/3.png" alt="">
        </div>
        <h3 class="tit-sec1">Puerta de ducha</h3>
    </div>
    <div class="sec-1-prod">
        <div class="sec1-prod-cont">
        <img class="img-sec1" src="img/4.png" alt="">
        </div>
        <h3 class="tit-sec1">Melamina</h3>
    </div>
    <div class="sec-1-prod">
        <div class="sec1-prod-cont">
            <img class="img-sec1" src="img/5.png" alt="">
        </div>
        <h3 class="tit-sec1">Cuadros</h3>
    </div>
    <div class="sec-1-prod">
        <div class="sec1-prod-cont">
            <img class="img-sec1" src="img/6.png" alt="">
        </div>
        <h3 class="tit-sec1">Mampara</h3>
    </div>
</div>
...
<article class="blok2">
    ...
    <img class="imgblok"  src="img/mmm.jpg" align="left" ><br>
    <h1 id="mision">MISION</h1> 



    <p  id="letra">
    Complacer a nuestros clientes con calidad y compromiso en 
los servicios que ofrecemos y en que nos confían. 
Contribuimos con la capacitacion de nuestros trabajadores, 
con los valores y principios de nuestra empresa.<br> <br> <br> 
 
    </p>
</article>

<article class="blok2">
    <img class="imgblok"  src="img/vvv.jpg" align="left" ><br>
    <h1 id="mision">VISION</h1>
    <p  id="letra">
Convertirnos una empresa lider tanto nacional como internacional que 
busca la sastifaccion de todos nuestros clientes,ofreciendo los 
mejores servicios y productos con la mejor calidad
para su proyecto que contribuyan a una mejor calidad de vida.
		<br/>	
    </p>
</article>

<article class="blok2">
    <img class="imgblok"  src="img/ggg.jpg" align="left" ><br>
    
    <h1 id="mision">Valores</h1>
...
* Orientacion   <br> 
* Cultura <br>
* Dedicacion al trabajo <br>
* Cumplimiento <br>	<br>	<br>	<br>	<br>	<br>	
    </p>
</article>


<article class="blok2">
    <img class="imgblok"  src="img/ppp.jpg" align="left" ><br>
    <h1 id="mision">Politica de Calidad</h1>
    <p id="letra">
    
    Estamos comprometidos con la satisfacción de nuestros clientes, practicamos 
    el cumplimiento efectivo de los valores y requisitos de calidad poniendo en práctica la 
    mejora continua en nuestro servicio.		
    <br>
    <br>
    <br>
    <br>
...
<div id="cont1">
    <div class="container cont-opcion">
        <ul>
            <a class="opcionLeft" href="#">VENTANAS</a>
            <li>
                <a href="#">Opcion</a>
            </li>
            <li>
...
<!--*****************---------------------------------------------------------------- Messenger Plugin de chat Code -->
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "278248302332617");
